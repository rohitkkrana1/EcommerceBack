...
class ProductQuery:
	...
	def query(self, attributes=None, tags=None, fields=None, search_term=None, start=0, item_group=None):
		"""
		Args:
		...
		if tags:
			result, count = self.query_items_with_tags(tags,start)
		else:
	...
	def query_items_with_tags(self,tags,start=0):
		"""Build a query to fetch Website Items based on field & tags filters."""
		item_names = []
		item_codes = []
		for value in tags:
